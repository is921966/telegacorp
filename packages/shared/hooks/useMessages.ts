...
export function useMessages(chatId: string | null, topicId?: number | null) {
    ...
    async (mode: LoadMode = "bottom", anchorId?: number) => {
      ...
      try {
        if (topicId) {
          ...
          const { getTopicMessages } = await import("../telegram/topics");
          ...
          if (mode === "bottom") {
            const { getMessages } = await import("../telegram/messages");
            ...
            setLoading(true);
            const { getMessagesAround } = await import("../telegram/messages");
            ...
            const { getNewerMessages } = await import("../telegram/messages");
  ...
  const edit = useCallback(
    async (messageId: number, text: string) => {
      ...
      const { editMessage } = await import("../telegram/messages");
  ...
  const remove = useCallback(
    async (messageIds: number[]) => {
      ...
      const { deleteMessages } = await import("../telegram/messages");
  ...
  const markChatAsRead = useCallback(
    async (maxId?: number) => {
      ...
      try {
        ...
        const { markAsRead } = await import("../telegram/dialogs");
